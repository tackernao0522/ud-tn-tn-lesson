## 22. パーツファイルに分けよう - header.php / footer.php

+ `mysite/app/public/wp-content/themes/myblog`ディレクトリに移動<br>

+ `$ touch header.php`を実行<br>
...
+ `wp-content/themes/myblog/index.php`を編集<br>
...
+ `wp-content/themes/myblog/single.php`を編集<br>
