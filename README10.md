...
## 24. ヘッダーやフッター以外もパーツ化しよう - get_template_part

+ `myblog`ディレクトリに手作業<br>

+ `$ mkdir includes && touch $_/header.php`を実行<br>
...
+ `$ touch includes/footer.php`を実行<br>

+ `wp-content/themes/myblog/includes/footer.php`を編集<br>
